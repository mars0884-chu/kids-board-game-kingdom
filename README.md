...
v0.14.0 在原 GitHub Pages 首頁的「冒險闖關」加入象棋六段互動教學，並保存本機課程進度；棋子圓面稍微縮小，窄版棋盤及控制列沿用已核准遊戲的卡牌層次。六種手機／平板尺寸的首頁進入、教學走棋與下一課瀏覽器檢查通過。公開網址不變：[GitHub Pages](https://mars0884-chu.github.io/kids-board-game-kingdom/)。製作人回報兩支 iPhone 15 Pro Max 使用電信商網路以八碼熟人房號及隨機配對完成象棋雙方各五步；此結果依回報記錄，不是代理人在本次版本重新實測。象棋協會規則的完整長將／長捉裁判、正式美術及台灣口音語音驗收仍未完成。
